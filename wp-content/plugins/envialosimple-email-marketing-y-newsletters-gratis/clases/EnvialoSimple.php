...
class EnvialoSimple extends Curl {
    ...
    function traerEnviosDisponibles() {
        $parametros = array();
        $respuesta = json_decode($this->curlJson($parametros, URL_BASE_API . "/administrator/status"), TRUE);
    ...
    function testToken() {
        $parametros = array();
        $resultado = json_decode($this->curlJson($parametros, URL_BASE_API . "/maillist/list/format/json"), TRUE);
    ...
    function obtenerEmailAdministrador() {
        $parametros = array();
        $email = json_decode($this->curlJson($parametros, URL_BASE_API . '/administratoremail/list/format/json'), TRUE);
