...
define( 'WPCACHEHOME', '/home/c1491514/public_html/tienda/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/c1491514/public_html/tienda';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c1491514_tienda');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c1491514_tienda');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'oyqlybtvltr1Pjv');
